...
WebUI.verifyElementText(findTestObject('Object Repository/div_Admin 2'), 'Admin 2')

WebUI.verifyElementPresent(findTestObject('Object Repository/div_Admin 2'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/div_Administrator'), 'Administrator')

WebUI.verifyElementPresent(findTestObject('Object Repository/div_Administrator'), 0)
