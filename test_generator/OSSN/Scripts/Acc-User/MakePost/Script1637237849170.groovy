...
WebUI.setText(findTestObject('Object Repository/textarea_Post_post'), 'user1 make post')
...
WebUI.setText(findTestObject('Object Repository/textarea_user1 make post'), 'user 1 edit post')

WebUI.click(findTestObject('Object Repository/a_Save'))

WebUI.click(findTestObject('Object Repository/i_Groups_fa fa-th-list'))

WebUI.click(findTestObject('Object Repository/li_News Feed'))
