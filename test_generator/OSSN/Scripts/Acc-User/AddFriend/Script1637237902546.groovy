...
WebUI.click(findTestObject('Object Repository/a_Add Friend'))
...
WebUI.click(findTestObject('Object Repository/li_Friends'))
...
WebUI.click(findTestObject('Object Repository/i_Log out_fa fa-users_1'))

WebUI.click(findTestObject('Object Repository/i_Groups_fa fa-th-list'))

WebUI.click(findTestObject('Object Repository/li_Friends (1)'))
