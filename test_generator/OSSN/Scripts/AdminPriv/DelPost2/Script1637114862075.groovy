...
WebUI.setText(findTestObject('textarea_Post_post (1)'), 'admin1 post user1')
...
WebUI.click(findTestObject('Object Repository/i_Privacy_fa fa fa-ellipsis-h_1'))

WebUI.click(findTestObject('a_Delete (1)'))
