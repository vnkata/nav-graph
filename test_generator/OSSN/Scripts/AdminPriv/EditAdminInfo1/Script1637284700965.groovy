...
WebUI.verifyElementText(findTestObject('Object Repository/a_Reset Password'), 'Reset Password')
...
WebUI.verifyElementText(findTestObject('Object Repository/div_Invalid username or password'), 'Invalid username or password!')
