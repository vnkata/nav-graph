...
WebUI.click(findTestObject('a_Save (1)'))

WebUI.verifyElementText(findTestObject('Object Repository/div_Post successfully saved'), 'Post successfully saved')

WebUI.click(findTestObject('i_Privacy_fa fa fa-ellipsis-h (1)'))

WebUI.click(findTestObject('a_Delete (2)'))

WebUI.click(findTestObject('Object Repository/i_OSSN_fa fa-sort-down_1'))
