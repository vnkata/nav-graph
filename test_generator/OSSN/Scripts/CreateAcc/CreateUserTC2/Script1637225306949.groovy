...
WebUI.setText(findTestObject('Object Repository/input_Username_username'), 'usertc2')

WebUI.setText(findTestObject('Object Repository/input_Email_email'), 'usertc2@test.com')
...
WebUI.verifyElementText(findTestObject('a_User TC2'), 'User TC2')
