...
WebUI.setText(findTestObject('Object Repository/input_Email_email'), 'admintc3@test.com')

WebUI.setText(findTestObject('Object Repository/input_Username_username'), 'admintc3')

WebUI.setText(findTestObject('Object Repository/input_First Name_firstname'), 'Admin')

WebUI.setText(findTestObject('Object Repository/input_Last Name_lastname'), 'TC3')
...
WebUI.click(findTestObject('a_Admin TC3'))

WebUI.verifyElementText(findTestObject('div_Admin TC3'), 'Admin TC3')
...
WebUI.verifyElementText(findTestObject('a_Admin TC3'), 'Admin TC3')
...
WebUI.verifyElementText(findTestObject('Object Repository/a_Administrator'), 'Administrator')

WebUI.verifyElementVisible(findTestObject('Object Repository/div_Administrator'))

WebUI.verifyElementVisible(findTestObject('Object Repository/a_Administrator'))
