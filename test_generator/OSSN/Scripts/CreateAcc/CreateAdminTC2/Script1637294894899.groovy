...
WebUI.setText(findTestObject('Object Repository/input_Email_email'), 'admintc2@test.com')

WebUI.setEncryptedText(findTestObject('Object Repository/input_Password_password'), 'RigbBhfdqODKcAsiUrg+1Q==')

WebUI.setText(findTestObject('Object Repository/input_First Name_firstname'), 'Admin')

WebUI.setText(findTestObject('Object Repository/input_Last Name_lastname'), 'TC2')

WebUI.setText(findTestObject('Object Repository/input_Username_username'), 'admintc2')
...
WebUI.click(findTestObject('a_Admin TC2'))

WebUI.verifyElementText(findTestObject('div_Admin TC2'), 'Admin TC2')
