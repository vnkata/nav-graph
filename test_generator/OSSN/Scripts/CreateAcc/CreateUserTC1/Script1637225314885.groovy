...
WebUI.setText(findTestObject('Object Repository/input_Username_username'), 'usertc1')

WebUI.setText(findTestObject('Object Repository/input_Email_email'), 'usertc1@test.com')
...
WebUI.verifyElementText(findTestObject('Object Repository/a_User TC1'), 'User TC1')

WebUI.click(findTestObject('Object Repository/a_User TC1'))

WebUI.setText(findTestObject('Object Repository/textarea_Post_post'), 'usertc1 post ')
...
WebUI.click(findTestObject('a_User TC1'))

WebUI.click(findTestObject('i_Privacy_fa fa fa-ellipsis-h (1)'))

WebUI.click(findTestObject('a_Edit (2)'))

WebUI.setText(findTestObject('Object Repository/textarea_usertc1 post (2)'), 'usertc1 post admin confirmed')
