...
WebUI.rightClick(findTestObject('Object Repository/Page_Element/div_haha'))

WebUI.click(findTestObject('Object Repository/Page_Element/span_Favorite'))

WebUI.rightClick(findTestObject('Object Repository/Page_Element/img_Favorites_mx_BaseAvatar_image'))

WebUI.click(findTestObject('Object Repository/Page_Element/span_Favorited'))
