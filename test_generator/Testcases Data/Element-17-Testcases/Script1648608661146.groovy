...
WebUI.click(findTestObject('Object Repository/Page_Element/span_General'))

WebUI.click(findTestObject('Object Repository/Page_Element/span_English (US)_mx_Dropdown_arrow'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Bahasa Indonesia'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_Element/img_Review_mx_BaseAvatar_image'))

WebUI.click(findTestObject('Object Repository/Page_Element/span_Semua pengaturan'))
