...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Aa_mx_Slider_dot'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Aa_mx_Slider_dot mx_Slider_dotActive'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Element/div_Customize your appearance'), 'Customize your appearance')
