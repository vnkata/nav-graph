...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Element/input_Username_password_1'), 'bWwU7ycMudE0EP5dTX/Rnw==')

WebUI.click(findTestObject('Object Repository/Page_Element/input_Forgot password_mx_Login_submit'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Element/div_Incorrect username andor password'), 0)
